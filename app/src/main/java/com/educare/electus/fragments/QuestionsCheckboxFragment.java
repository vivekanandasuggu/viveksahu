 ...
 */
public class QuestionsCheckboxFragment extends Fragment {

    private TextView tv_qstn;
    private RecyclerView rv_answer_options;
    private int questionNumber=0;
    public QuestionsCheckboxFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_questions_checkbox, container, false);
        ...
        tv_qstn.setText(questionNumber+") Hyderabad is the captial of which state?");
    ...
    class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.AnswersHolder>{
        ...
        public AnswersHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.list_item_questions_check_box, viewGroup, false);
